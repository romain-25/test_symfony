...
class __TwigTemplate_c9edfcfae5b12a1a4392dddab869619483fcb3d4ca41c00501a1714ca867b967 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["projets"]) || array_key_exists("projets", $context) ? $context["projets"] : (function () { throw new RuntimeError('Variable "projets" does not exist.', 16, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["projet"]) {
            ...
            echo "            <tr>
                <td>";
            // line 18
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["projet"], "id", [], "any", false, false, false, 18), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 20
...
{% block body %}
    ...
    <table class=\"table\">
        ...
        {% for projet in projets %}
            <tr>
                <td>{{ projet.id }}</td>
                <td>
                    <a href=\"{{ path('projets_show', {'id': projet.id}) }}\">show</a>
    ...
    <a href=\"{{ path('projets_new') }}\">Create new</a>
{% endblock %}
", "projets/index.html.twig", "C:\\wamp64\\www\\test_symfony\\templates\\projets\\index.html.twig");
    }
}
