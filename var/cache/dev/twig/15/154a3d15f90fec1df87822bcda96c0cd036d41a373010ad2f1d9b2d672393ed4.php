...
class __TwigTemplate_debe43c0e40a09c616b313d00964424fc0390cab9d6407c59b676339517c608d extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        // line 19
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("projets_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["projet"]) || array_key_exists("projet", $context) ? $context["projet"] : (function () { throw new RuntimeError('Variable "projet" does not exist.', 19, $this->source); })()), "id", [], "any", false, false, false, 19)]), "html", null, true);
        echo "\">edit</a>
...
{% endblock %}
", "projets/show.html.twig", "C:\\wamp64\\www\\test_symfony\\templates\\projets\\show.html.twig");
    }
}
